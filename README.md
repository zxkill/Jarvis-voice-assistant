...
* Надёжный драйвер Serial для M5Stack: фильтрация шумного JSON, игнорирование текстовых логов и автоматическое восстановление соединения; прошивка отключает вывод логов в USB‑Serial, чтобы канал использовался только для команд
