...
ассистента более естественным.  Глобальный таймер следит за тем, чтобы
даже при одновременном запуске нескольких экземпляров драйвера звук не
воспроизводился чаще допустимого интервала.
