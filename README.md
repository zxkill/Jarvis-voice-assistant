...
уведомлений, реализовав одноимённую функцию в своём модуле.  Для
удалённого управления через Telegram запустите
`python3 -m notifiers.telegram_listener` — модуль будет получать команды
от владельца и передавать их ассистенту.
