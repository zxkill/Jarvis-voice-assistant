...
15. [Roadmap и лицензия](#roadmap-и-лицензия)
...
Jarvis выступает как голосовой коуч и персональный ассистент: он даёт диалоговые подсказки и проактивные напоминания, а ответы пользователя сохраняются в `memory/jarvis.db`. На их основе ассистент уточняет частоту подсказок и подстраивается под привычки владельца.
