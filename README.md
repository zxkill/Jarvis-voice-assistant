...
9. [Small-talk и проактивное общение](#small-talk-и-проактивное-общение)
10. [Прошивка для M5Stack Core ESP32](#прошивка-для-m5stack-core-esp32)
11. [Разработка своих скиллов](#разработка-своих-скиллов)
12. [Roadmap и лицензия](#roadmap-и-лицензия)
...
* Проактивный small-talk при длительном молчании пользователя
...
Jarvis может сам начинать разговор, если рядом есть пользователь и долго нет команд. 
Фразы вроде «Как дела?» или «Пора размяться!» создают ощущение живого диалога.
