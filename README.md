...
активации «джарвис» распознано с задержкой, в движок Vosk отправляется
накопленная история звука, и начало команды не теряется. Такой подход
повышает точность распознавания и делает общение с ассистентом более
естественным.
