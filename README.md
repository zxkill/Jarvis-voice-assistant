...
активно), а ``frame_rotation`` позволяет повернуть кадр на 90° / 180° /
270° при нестандартной установке камеры.  Закрыть окно можно клавишей
``q``.  Это помогает убедиться, что камера захватывает изображение и
