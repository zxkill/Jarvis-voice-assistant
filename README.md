...
Детектор построен на OpenCV и при необходимости использует MediaPipe; если библиотека не установлена, система выводит предупреждение в лог и продолжает работу без распознавания.
